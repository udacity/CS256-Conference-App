...
define([], function () {
    ...
    contentDiv.classList.add('sessions-container');
    ...
    contentDiv.appendChild(gridContent);

    var timeline = document.createElement('ol');
    timeline.classList.add('timeline');

    scheduleGrid.appendChild(timeline);
    scheduleGrid.appendChild(contentDiv);
    ...
    function onGridScroll() {
        console.log('onGridScroll() :) gridContent.scrollTop = '+gridContent.scrollTop);
